...
class Config:
    ...
    def validate(self, required_sections: str | list | None = None) -> None:
        ...
        if file_to_table is not None and "default" not in file_to_table:
            raise ConfigurationError("file_to_table.default is required when file_to_table is defined",
                                     key="file_to_table.default")
